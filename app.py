...
# Layout de 2 columnas (Formulario a la derecha, Gráfico a la izquierda)
...
nombres = [item["nudo"] for item in st.session_state.nudos]
longitudes = [item["longitud"] for item in st.session_state.nudos]
